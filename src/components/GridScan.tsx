...
function smoothDampVec2(
  current: THREE.Vector2, target: THREE.Vector2, vel: THREE.Vector2,
...
export default function GridScan({
  ...
  useEffect(() => {
    ...
    const onLeave = () => {
      ...
      leaveTimer = setTimeout(() => { lookTarget.current.set(0, 0); }, Math.max(0, snapBackDelay));
    };
  ...
  return (
    <div ref={containerRef} className={className} style={{ position: 'absolute', inset: 0, pointerEvents: 'auto' }} />
  );
}
